...
const JsTips = () => {
  ...
  return (
    <div className="md:w-3/4 w-11/12 top-14 right-0 absolute bg-crbg border-t-2 md:px-10 px-4 pt-6 border-txt h-full animate__animated animate__fadeInRight">
