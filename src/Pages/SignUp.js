          ...
          <div className="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
            <form className="max-w-md mx-auto" onSubmit={submitHandler}>
              ...
              <div className="mb-6">
                <input
                  type="text"
                  className={`form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700  focus:border-blue-600 focus:outline-none focus:shadow-sm focus:shadow-login-blu`}
              ...
              <div className="flex flex-row items-center justify-center">
                <p className="text-lg mb-0 mr-4 text-white">Sign up with</p>
                <button
                  type="button"
